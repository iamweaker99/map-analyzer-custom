...
pub struct JumpAnalysis {
    ...
    pub avg_spacing: f64,
    pub absolute_short_count: i32,
    pub absolute_medium_count: i32,
    pub absolute_long_count: i32,
    pub absolute_extreme_count: i32,
    pub absolute_cross_screen_count: i32,
    pub max_jump_length: i32,
    pub max_jump_duration: f64,
    pub duration_short_chains: i32,
    pub duration_medium_chains: i32,
    pub duration_long_chains: i32,
    pub duration_extreme_chains: i32,
